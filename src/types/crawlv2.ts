...
export const locations: Location[] = [
  ...
  { id: 'empty12', type: 'empty', index: 2, player: null, name: null },
  {
    ...
    player: 'player1',
    name: 'Trap',
    column: ['unit11', 'unit14', 'unit21', 'unit24'],
    neighbouring: ['trap12'],
  },
  {
    id: 'trap12',
    ...
    player: 'player1',
    name: 'Trap',
    column: ['unit12', 'unit15', 'unit22', 'unit25'],
    neighbouring: ['trap11', 'trap13'],
  },
  {
    id: 'trap13',
    type: 'trap',
    ...
    player: 'player1',
    name: 'Trap',
    column: ['unit13', 'unit16', 'unit23', 'unit26'],
    neighbouring: ['trap12'],
  },
  ...
  { id: 'empty22', type: 'empty', index: 2, player: null, name: null },
  {
    ...
    player: 'player2',
    name: 'Trap',
    column: ['unit21', 'unit24', 'unit11', 'unit14'],
    neighbouring: ['trap22'],
  },
  {
    id: 'trap22',
    ...
    player: 'player2',
    name: 'Trap',
    column: ['unit22', 'unit25', 'unit12', 'unit15'],
    neighbouring: ['trap21', 'trap23'],
  },
  {
    id: 'trap23',
    type: 'trap',
