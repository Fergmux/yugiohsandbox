<template>
  <div
    class="mx-auto grid h-full max-h-screen w-full max-w-[100vh] grid-cols-[2fr_2fr_3fr_3fr_3fr_2fr_2fr] grid-rows-[3fr_2fr_3fr_3fr_1fr_3fr_3fr_2fr_3fr] gap-x-[5vw] gap-y-2 bg-cover bg-center px-40 py-20 select-none"
